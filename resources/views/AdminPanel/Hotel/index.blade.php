...
<div class="container mt-4">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#hotelModal" onclick="openCreateForm()">+ Add Hotel</button>
        </div>
        <div class="card-body">
                    ...
                    @forelse($hotels as $hotel)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('hotels.destroy', $hotel->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this hotel?')">
                                    @csrf
                                    @method('DELETE')
            ...
            <form id="hotelForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" id="hotelLocation" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Rating (1-5)</label>
                        <input type="number" name="rating" id="hotelRating" class="form-control" min="1" max="5">
                    </div>
                    <div class="mb-3">
